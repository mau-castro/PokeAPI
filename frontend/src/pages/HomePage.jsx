      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-20">
          ...
          {!isAuthenticated() && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/register"
                className="px-8 py-3 bg-white text-red-600 font-semibold border-2 border-red-600 rounded-lg hover:bg-red-50 transition"
              >
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t.home.featureSearchTitle}</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t.home.featureFavTitle}</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t.home.featureStatsTitle}</h3>
            <p className="text-gray-600">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">{t.home.howItWorks}</h2>
